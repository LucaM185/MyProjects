...
## Web Development
1. **Manim Studio** (My first big project, re-built 6 times with new technologies while learning tech html, typescript, flutter, docker, etc...)
...
2. **STEM** (very old project, i was 16yo, not super relevant anymore, im quite proud of the fact that there was no AI) 
...
## Mobile Apps
7. **Flutter** (Basically not relevant anymore, i made apps way better than this) 
   - Flutter math app
